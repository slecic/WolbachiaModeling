...
t2.long$total <- 25
t2.long$inf <- (t2.long$infection*t2.long$total)/100
t2.long$uninf <- t2.long$total - t2.long$inf
# remove locations with NA for lon and/or lat
t2.long.latlon <-subset(t2.long, !is.na(latitude) & !is.na(longitude))
t2.long.latlon.pasohl2 <- subset(t2.long.latlon, pop != "Pasohlavky-Ivan 2")
t2.long.latlon.pasohl23 <- subset(t2.long.latlon.pasohl2, pop != "Pasohlavky-Ivan 3")
t2.long.latlon.pasohl23hayani <- subset(t2.long.latlon.pasohl23, pop != "Hajany")
t2.long.latlon.pasohl23hayani$total <- c(48, 48, NA, NA, NA, NA, # Alt Prerau
                      18, NA, NA, NA, NA, NA, # Jevisovka
                      26, NA, 24, NA, NA, NA,  # Drnholec 1
                      7, NA, NA, NA, NA, NA, # Drnholec 2
                      NA, NA, 24, NA, NA, 24, # Drnholec 3
                      13, NA, NA, NA, NA, NA, # Pasohlavky 1
                      14, NA, NA, NA, NA, NA, # Pasohlavky 2
                      NA, 24, 24, 24, NA, 24, # Pasohlavky 3
                      12, NA, 11, NA, NA, NA, # Ivan 1
                      48, 48, 24, 24, 24, 48, # Ivan 2
                      NA, NA, NA, 24, 24, 24, # Ivan-Vranovice 1
                      NA, NA, NA, 24, 24, 24, # Ivan-Vranovice 2
                      NA, NA, NA, 24, 24, NA, # Vranovice 1
                      NA, NA, NA, 24, 24, 24, # Vranovice 2
                      NA, NA, NA, 48, NA, NA, # Vranovice-Prisnotice
                      NA, NA, NA, 36, 24, 24, # Prisnotice
                      42, 46, NA, 24, 24, NA, # Velke Nemcice 1
                      NA, NA, 42, NA, NA, NA, # Velke Nemcice Center
                      13, NA, NA, NA, NA, NA, # Velke Nemcice 2
                      12, NA, NA, NA, NA, NA, # Nosislav 1
                      9, NA, 24, 24, 24, 24, # NosislavZidlochovice 2
                      NA, NA, NA, NA, NA, 24, # Zabcice
                      48, 48, 24, 24, NA, NA, # Zidlochovice
                      NA, NA, NA, NA, NA, 24, # Zidlochovice-1
                      NA, NA, NA, NA, NA, 48, # Vojkovice
                      48, NA, 24, 24, NA, NA, # Holasice
                      48, 48, 26, 24, 24, 24, # Rajhrad
                      NA, NA, NA, 24, 24, NA, # Popovice  sewage works
                      NA, NA, NA, NA, NA, 24, # Popovice  Village
                      NA, NA, NA, 24, NA, NA, # Popovice  train station
                      NA, NA, NA, 24, NA, NA, # Modrice 1
                      NA, NA, NA, 24, NA, NA, # Modrice 2
                      32, NA, NA, NA, NA, NA, # Zelesice
                      14, NA, 26, 48, NA, 24, # Obchodní Centrum Futurum
                      48, NA, 32, NA, 24, 24, # Brno  Spilberk Castle
                      48, NA, NA, NA, NA, NA, # Brno  Mendel University
                      NA, NA, 26, 48, 48, NA, # Brno  Erbenova
                      NA, NA, 24, NA, NA, NA, # Soběšice
                      NA, NA, NA, 48, 24, NA, # Soběšice 1
                      NA, NA, NA, NA, NA, 23, # Soběšice 1x
                      NA, NA, 20, 40, NA, 24, # Utechov
                      NA, NA, NA, 24, NA, 24, # Vranov
                      NA, NA, NA, NA, NA, 17, # Olesna
                      NA, NA, NA, NA, NA, 24, # Rajecko
                      NA, NA, NA, NA, NA, 24 # Cerna Hora
) # 
t2.long.latlon.pasohl23hayani$inf <- c(48, 48, NA, NA, NA, NA, # Alt Prerau
                    18, NA, NA, NA, NA, NA, # Jevisovka
                    26, NA, 24, NA, NA, NA, # Drnholec 1
                    7, NA, NA, NA, NA, NA, # Drnholec 2
                    NA, NA, 20, NA, NA, 24, # Drnholec 3 
                    11, NA, NA, NA, NA, NA, # Pasohlavky 1
                    13, NA, NA, NA, NA, NA, # Pasohlavky 2
                    NA, 24, 21, 24, NA, 22, # Pasohlavky 3
                    11, NA, 10, NA, NA, NA, # Ivan 1
                    34, 47, 24, 24, 24, 48, # Ivan 2 
                    NA, NA, NA, 19, 21, 21, # Ivan-Vranovice 1
                    NA, NA, NA, 19, 21, 24, # Ivan-Vranovice 2 
                    NA, NA, NA, 21, 21, NA, # Vranovice 1
                    NA, NA, NA, 19, 13, 13, # Vranovice 2
                    NA, NA, NA, 24, NA, NA, # Vranovice-Prisnotice
                    NA, NA, NA, 33, 20, 17, # Prisnotice
                    19, 22, NA, 23, 23, NA, # Velke Nemcice 1
                    NA, NA, 21, NA, NA, NA, # Velke Nemcice Center
                    5, NA, NA, NA, NA, NA, # Velke Nemcice 2
                    2, NA, NA, NA, NA, NA, # Nosislav 1
                    2, NA, 1, 7, 10, 12, # NosislavZidlochovice 2
                    NA, NA, NA, NA, NA, 12, # Zabcice
                    3, 1, 2, 0, NA, NA, # Zidlochovice
                    NA, NA, NA, NA, NA, 5, # Zidlochovice-1
                    NA, NA, NA, NA, NA, 12, # Vojkovice
                    5, NA, 2, 1, NA, NA, # Holasice
                    0, 2, 3, 1, 1, 2, # Rajhrad
                    NA, NA, NA, 3, 0, NA, # Popovice  sewage works
                    NA, NA, NA, NA, NA, 1, # Popovice  Village
                    NA, NA, NA, 2, NA, NA, # Popovice  train station
                    NA, NA, NA, 5, NA, NA, # Modrice 1
                    NA, NA, NA, 0, NA, NA, # Modrice 2
                    0, NA, NA, NA, NA, NA, # Zelesice
                    0, NA, 0, 0, NA, 0, # Obchodní Centrum Futurum
                    2, NA, 1, NA, 1, 3, # Brno  Spilberk Castle
                    2, NA, NA, NA, NA, NA, # Brno  Mendel University
                    NA, NA, 1, 0, 4, NA, # Brno  Erbenova
                    NA, NA, 0, NA, NA, NA, # Soběšice
                    NA, NA, NA, 7, 3, NA, # Soběšice 1
                    NA, NA, NA, NA, NA, 1, # Soběšice 1x
                    NA, NA, 0, 5, NA, 0, # Utechov
                    NA, NA, NA, 3, NA, 1, # Vranov
                    NA, NA, NA, NA, NA, 0, # Olesna *
                    NA, NA, NA, NA, NA, 0, # Rajecko
                    NA, NA, NA, NA, NA, 2 # Cerna Hora
) #
t2.long.latlon.pasohl23hayani$uninf <- t2.long.latlon.pasohl23hayani$total - t2.long.latlon.pasohl23hayani$inf
t2.long.latlon.pasohl23hayani$infectionFreq <- t2.long.latlon.pasohl23hayani$inf/t2.long.latlon.pasohl23hayani$total
#t2.long.latlon.pasohl23hayani$infection <- NULL
write.csv(t2.long.latlon.pasohl23hayani, "/Volumes/LaCie/the_cline/T2transect.csv", row.names=FALSE)
t2.long.latlon.pasohl23hayani.na <- na.omit(t2.long.latlon.pasohl23hayani)


# omit NAs
t2.long[!is.na(t2.long$inf),]
t2.long.na <- na.omit(t2.long)
t2.long.na$total <- c(48, 48, # Alt Prerau
                      18, # Jevisovka
                      26, 24, # Drnholec 1
                      7, # Drnholec 2
                      24, 24, # Drnholec 3
                      13, # Pasohlavky 1
                      14, # Pasohlavky 2
                      24, 24, 24, 24, # Pasohlavky 3
                      12, 11, # Ivan 1
                      48, 48, 24, 24, 24, 48, # Ivan 2
                      24, 24, 24, # Ivan-Vranovice 1
                      24, 24, 24, # Ivan-Vranovice 2
                      24, 24, # Vranovice 1
                      24, 24, 24, # Vranovice 2
                      48, # Vranovice-Prisnotice
                      36, 24, 24, # Prisnotice
                      42, 46, 24, 24, # Velke Nemcice 1
                      42, # Velke Nemcice Center
                      13, # Velke Nemcice 2
                      12, # Nosislav 1
                      9, 24, 24, 24, 24, # NosislavZidlochovice 2
                      24, # Zabcice
                      48, 48, 24, 24, # Zidlochovice
                      24, # Zidlochovice-1
                      48, # Vojkovice
                      48, 24, 24, # Holasice
                      48, 48, 26, 24, 24, 24, # Rajhrad
                      24, 24, # Popovice  sewage works
                      24, # Popovice  Village
                      24, # Popovice  train station
                      24, # Modrice 1
                      24, # Modrice 2
                      32, # Zelesice
                      14, 26, 48, 24, # Obchodní Centrum Futurum
                      48, 32, 24, 24, # Brno  Spilberk Castle
                      48, # Brno  Mendel University
                      26, 48, 48, # Brno  Erbenova
                      24, # Soběšice
                      48, 24, # Soběšice 1
                      23, # Soběšice 1x
                      20, 40, 24, # Utechov
...
t2.long.na$inf <- c(48, 48, # Alt Prerau
                    18, # Jevisovka
                    26, 24, # Drnholec 1
                    7, # Drnholec 2
                    20, 24, # Drnholec 3 
                    11, # Pasohlavky 1
                    13, # Pasohlavky 2
                    0, 21, 24, 22, # Pasohlavky 3
                    11, 10, # Ivan 1
                    34, 47, 24, 24, 24, 48, # Ivan 2 
                    19, 21, 21, # Ivan-Vranovice 1
                    19, 21, 24, # Ivan-Vranovice 2 
                    21, 21, # Vranovice 1
                    19, 13, 13, # Vranovice 2
                    24, # Vranovice-Prisnotice
                    33, 20, 17, # Prisnotice
                    19, 22, 23, 23, # Velke Nemcice 1
                    21, # Velke Nemcice Center
                    5, # Velke Nemcice 2
                    2, # Nosislav 1
                    2, 1, 7, 10, 12, # NosislavZidlochovice 2
                    12, # Zabcice
                    3, 1, 2, 0, # Zidlochovice
                    5, # Zidlochovice-1
                    12, # Vojkovice
                    5, 2, 1, # Holasice
                    0, 2, 3, 1, 1, 2, # Rajhrad
                    3, 0, # Popovice  sewage works
                    1, # Popovice  Village
                    2, # Popovice  train station
                    5, # Modrice 1
                    0, # Modrice 2
                    0, # Zelesice
                    0, 0, 0, 0, # Obchodní Centrum Futurum
                    2, 1, 1, 3, # Brno  Spilberk Castle
                    2, # Brno  Mendel University
                    1, 0, 4, # Brno  Erbenova
                    0, # Soběšice
                    7, 3, # Soběšice 1
                    1, # Soběšice 1x
...
#t2.long.na$inf <- (t2.long.na$infection*t2.long.na$total)/100
t2.long.na$uninf <- t2.long.na$total - t2.long.na$inf
t2.long.na$infectionFreq <- t2.long.na$inf/t2.long.na$total
t2.long.na$infection <- NULL
write.csv(t2.long.na, "/Volumes/LaCie/the_cline/t2_transect.csv", row.names=FALSE)
